...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aurelia — Hotel & Restaurant Management" },
      { name: "description", content: "Aurelia is a premium hotel and restaurant management platform: bookings, housekeeping, restaurant floor, orders, billing and revenue in one place." },
      { name: "author", content: "Aurelia" },
      { property: "og:title", content: "Aurelia — Hotel & Restaurant Management" },
